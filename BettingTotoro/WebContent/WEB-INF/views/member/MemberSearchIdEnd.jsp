<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    String MemberSearchid =(String)request.getAttribute("MemberSearchid");
...
<body>
  ...
  <%if(MemberSearchid!=null){ %>
     아이디는<%=MemberSearchid %>입니다.
  <%} else{ %>
  <%=MemberSearchid %>
  <%} %>
  <br />
  ...
  <%--  <button onclick="location.href='<%=request.getContextPath() %>/member/memberEnroll'">회원가입</button>  --%>
